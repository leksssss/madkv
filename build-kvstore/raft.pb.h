...
class LogEntry final :
 ...
 public:
  ...
  public:
  void clear_command();
  const ::kvstore::KeyValuePair& command() const;
  PROTOBUF_NODISCARD ::kvstore::KeyValuePair* release_command();
  ::kvstore::KeyValuePair* mutable_command();
  void set_allocated_command(::kvstore::KeyValuePair* command);
  private:
  const ::kvstore::KeyValuePair& _internal_command() const;
  ::kvstore::KeyValuePair* _internal_mutable_command();
  public:
  void unsafe_arena_set_allocated_command(
      ::kvstore::KeyValuePair* command);
  ::kvstore::KeyValuePair* unsafe_arena_release_command();
...
inline int32_t AppendEntriesResponse::match_index() const {
  // @@protoc_insertion_point(field_get:raft.AppendEntriesResponse.match_index)
...
inline void AppendEntriesResponse::set_match_index(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:raft.AppendEntriesResponse.match_index)
}
...
inline const ::kvstore::KeyValuePair& LogEntry::_internal_command() const {
  const ::kvstore::KeyValuePair* p = _impl_.command_;
  return p != nullptr ? *p : reinterpret_cast<const ::kvstore::KeyValuePair&>(
      ::kvstore::_KeyValuePair_default_instance_);
}
inline const ::kvstore::KeyValuePair& LogEntry::command() const {
...
inline ::kvstore::KeyValuePair* LogEntry::release_command() {
  
  ::kvstore::KeyValuePair* temp = _impl_.command_;
...
inline ::kvstore::KeyValuePair* LogEntry::unsafe_arena_release_command() {
...
inline ::kvstore::KeyValuePair* LogEntry::_internal_mutable_command() {
  
  if (_impl_.command_ == nullptr) {
    auto* p = CreateMaybeMessage<::kvstore::KeyValuePair>(GetArenaForAllocation());
    _impl_.command_ = p;
  }
  return _impl_.command_;
}
inline ::kvstore::KeyValuePair* LogEntry::mutable_command() {
  ::kvstore::KeyValuePair* _msg = _internal_mutable_command();
  // @@protoc_insertion_point(field_mutable:raft.LogEntry.command)
  return _msg;
}
inline void LogEntry::set_allocated_command(::kvstore::KeyValuePair* command) {
