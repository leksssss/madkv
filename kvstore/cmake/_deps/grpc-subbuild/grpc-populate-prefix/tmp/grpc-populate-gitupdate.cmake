...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "vGRPC_TAG_VERSION_OF_YOUR_CHOICE"
  WORKING_DIRECTORY "/users/lekha/madkv/kvstore/cmake/_deps/grpc-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "vGRPC_TAG_VERSION_OF_YOUR_CHOICE")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("vGRPC_TAG_VERSION_OF_YOUR_CHOICE" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/vGRPC_TAG_VERSION_OF_YOUR_CHOICE")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"vGRPC_TAG_VERSION_OF_YOUR_CHOICE\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/users/lekha/madkv/kvstore/cmake/_deps/grpc-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/users/lekha/madkv/kvstore/cmake/_deps/grpc-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
